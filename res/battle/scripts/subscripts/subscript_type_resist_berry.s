...
_000:
    ...
    CheckAbility CHECK_NOT_HAVE, BTLSCR_ATTACKER, ABILITY_NORMALIZE, refrigerate
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, 0x00000000
    GoTo _033

refrigerate:
    CheckAbility CHECK_NOT_HAVE, BTLSCR_ATTACKER, ABILITY_REFRIGERATE, aerilate
    CompareVarToValue OPCODE_NEQ, BTLVAR_MOVE_TYPE, TYPE_NORMAL, _031
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, 0x0000000F
    GoTo _033

aerilate:
    CheckAbility CHECK_NOT_HAVE, BTLSCR_ATTACKER, ABILITY_AERILATE, galvanize
    CompareVarToValue OPCODE_NEQ, BTLVAR_MOVE_TYPE, TYPE_NORMAL, _031
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, 0x00000002
    GoTo _033

galvanize:
    CheckAbility CHECK_NOT_HAVE, BTLSCR_ATTACKER, ABILITY_GALVANIZE, normal
    CompareVarToValue OPCODE_NEQ, BTLVAR_MOVE_TYPE, TYPE_NORMAL, _031
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, 0x000000D
    GoTo _033
