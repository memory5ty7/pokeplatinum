...
_000:
    CheckAbility CHECK_NOT_HAVE, BTLSCR_SWITCHED_MON, ABILITY_UNNERVE, _realHazardsCheck

_printUnnerveMessage:
    // {0}’s {1} makes the opposing team too nervous to eat Berries!
    PrintMessage pl_msg_00000368_0110, TAG_NICKNAME_ABILITY_MOVE, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP
    Wait
    WaitButtonABTime 30
    SetAbilityActivatedFlag BTLSCR_SWITCHED_MON
...
_realHazardsCheck:
    ...
    CheckItemHoldEffect CHECK_HAVE, BTLSCR_SWITCHED_MON, HOLD_EFFECT_UNGROUND_DESTROYED_ON_HIT, _085
...
_059:
    CheckItemHoldEffect CHECK_HAVE, BTLSCR_SWITCHED_MON, HOLD_EFFECT_HEAVY_DUTY_BOOTS, _105
