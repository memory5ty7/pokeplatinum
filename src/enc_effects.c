...
enum EncEffectsPairID {
    ...
    ENCEFF_SPECIAL_TRAINER,
    ENCEFF_PAUL,
    ENCEFF_GALACTIC_MANAGER,
    ENCEFF_HUNTER_J,

    ENCEFF_MAX,
};

static const EncEffectsPair sEncEffectsTable[39] = {
    ...
    [ENCEFF_SPECIAL_TRAINER] = { ENCEFF_CUTIN_USE_LOCAL, SEQ_Z_VS_SPECIAL },
    [ENCEFF_PAUL] = { ENCEFF_CUTIN_USE_LOCAL, SEQ_Z_VS_PAUL },
    [ENCEFF_GALACTIC_MANAGER] = { ENCEFF_CUTIN_GALACTIC_GRUNT, SEQ_Z_VS_MANAGER },
    [ENCEFF_HUNTER_J] = { ENCEFF_CUTIN_USE_LOCAL, SEQ_BATTLE_GALACTIC_CMDR }
};
...
static u32 EncEffects_TrainerClassEffect(u32 trainerClass)
{
    ...
    case TRAINER_CLASS_MANAGER_NEPTUNE:
        result = ENCEFF_GALACTIC_MANAGER;
        break;
