...
{ //                                                                                Defending Type
  ...
  // Attacking Type  
    ...
    [TYPE_GROUND]   = { ______, ______, X(0_0), X(2_0), ______, X(2_0), X(0_5), ______, X(2_0), X(2_0), X(2_0), ______, X(0_5), X(2_0), ______, ______, ______, ______ },
    ...
    [TYPE_GHOST]    = { X(0_0), ______, ______, ______, ______, ______, ______, X(2_0), ______, ______, ______, ______, ______, ______, X(2_0), ______, ______, X(0_5) },
    ...
    [TYPE_DARK]     = { ______, X(0_5), ______, ______, ______, ______, ______, X(2_0), ______, X(0_5), ______, ______, ______, ______, X(2_0), ______, ______, X(0_5) }
};
// clang-format on
