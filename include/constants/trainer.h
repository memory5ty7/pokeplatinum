...
enum TrainerClass {
    ...
    TRAINER_CLASS_PAUL,
    TRAINER_CLASS_CONWAY,
    TRAINER_CLASS_NANDO,
    TRAINER_CLASS_REGGIE,
    TRAINER_CLASS_ROWAN,
    TRAINER_CLASS_HUNTER_J,
    TRAINER_CLASS_TOBIAS,
    TRAINER_CLASS_MANAGER_MERCURY,
    TRAINER_CLASS_MANAGER_VENUS,
    TRAINER_CLASS_MANAGER_URANUS,
    TRAINER_CLASS_MANAGER_NEPTUNE,
};
