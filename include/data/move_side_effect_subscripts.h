...
static const int sSideEffectSubscripts[] = {
    ...
    [MOVE_SUBSCRIPT_PTR_ACROBATICS]                       = subscript_acrobatics,
    [MOVE_SUBSCRIPT_PTR_FIRST_IMPRESSION]                 = subscript_first_impression,
    [MOVE_SUBSCRIPT_PTR_HEX]                              = subscript_hex,
    [MOVE_SUBSCRIPT_PTR_VENOSHOCK]                        = subscript_venoshock,
    ...
    [MOVE_SUBSCRIPT_PTR_RECOVER_QUARTER_MAX_HP]           = subscript_recover_quarter_max_hp,
    [MOVE_SUBSCRIPT_PTR_USER_SPEED_UP_AND_DEF_DOWN_1_STAGE] = subscript_user_speed_up_and_def_down_1_stage,
};
// clang-format on
