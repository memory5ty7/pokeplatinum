...
static const u8 sTrainerClassGender[] = {
    ...
    [TRAINER_CLASS_REGGIE]                  = GENDER_MALE,
    [TRAINER_CLASS_ROWAN]                   = GENDER_MALE,
    [TRAINER_CLASS_HUNTER_J]                = GENDER_FEMALE,
    [TRAINER_CLASS_TOBIAS]                  = GENDER_MALE,
    [TRAINER_CLASS_MANAGER_MERCURY]         = GENDER_FEMALE,
    [TRAINER_CLASS_MANAGER_VENUS]           = GENDER_FEMALE,
    [TRAINER_CLASS_MANAGER_URANUS]          = GENDER_MALE,
    [TRAINER_CLASS_MANAGER_NEPTUNE]         = GENDER_MALE,
};
// clang-format on
