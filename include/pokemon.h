 ...
 * @param monSpecies
 * @param monForm
 * @param[out] monLevelUpMoveIDs Pointer to a u32 array for storing the level up moves
 * @return int
 */
 ...
 * @param monSpecies
 * @param monForm
 * @param[out] monLevelUpMoves Pointer to a u32 array to store the move table
 */
...
void LoadSpeciesEvolutions(int monSpecies, SpeciesEvolution speciesEvolution[MAX_EVOLUTIONS]);
